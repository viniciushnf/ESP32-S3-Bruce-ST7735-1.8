...
// For ST7735, ST7789 and ILI9341 ONLY, define the colour order IF the blue and red are swapped on your
// display Try ONE option at a time to find the correct colour order for your display
