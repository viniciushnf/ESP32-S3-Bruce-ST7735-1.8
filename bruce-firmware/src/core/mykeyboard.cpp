...
#define KBLH 20 // Keyboard Buttons Line Height
    ...
    int btns_layout[buttons_number][3] = {
        ...
        {22,  32, 27 }, // CAP button
        {54,  32, 59 }, // DEL button
        {86,  42, 91 }, // SPACE button
        {128, 32, 133}, // BACK button
    };
    ...
    while (1) {
        if (redraw) {
            ...
            if (y < 0 || old_y < 0) {
                ...
                tft.drawString("OK", btns_layout[0][2], 8);
                // CAP
                if (x == 1 && y == -1) {
                    tft.setTextColor(bruceConfig.bgColor, getComplementaryColor2(bruceConfig.bgColor));
                    tft.fillRect(
                ...
                tft.drawString("CAP", btns_layout[1][2], 8);
                // DEL
                if (x == 2 && y == -1) {
                    tft.setTextColor(bruceConfig.bgColor, getComplementaryColor2(bruceConfig.bgColor));
                    tft.fillRect(
                ...
                tft.drawString("DEL", btns_layout[2][2], 8);
                // SPACE
                if (x == 3 && y == -1) {
                    tft.setTextColor(bruceConfig.bgColor, getComplementaryColor2(bruceConfig.bgColor));
                    tft.fillRect(
                ...
                tft.drawString("SPACE", btns_layout[3][2], 8);
           ...
           //   BACK
                ...
                tft.drawString("BACK", btns_layout[4][2], 8);
#endif
            }
