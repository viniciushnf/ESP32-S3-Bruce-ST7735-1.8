...
void showDeviceInfo() {
    ...
    area.addLine("Bruce Firmware:");
    area.addLine("- https://bruce.computer/");
    area.addLine("");
    area.addLine("Modified by ViniciusHNF:");
    area.addLine("- https://github.com/viniciushnf/ESP32-S3-Bruce-ST7735-1.8");
    area.addLine("");
    area.addLine(
        "The Bruce Firmware has been modified to be compatible with the ESP32-S3 and the 1.8-inch ST7735 "
        "display."
    );
